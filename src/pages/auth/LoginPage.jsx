      ...
      <div className="min-h-screen flex items-center justify-center p-6 pt-20">
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-white/40 text-sm">Continue your journey with verified insights.</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group/input">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-2xl py-4 pl-12 pr-4 outline-none focus:border-primary/50 focus:bg-white/10 transition-all text-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between px-1">
                ...
                <button className="text-[10px] text-primary hover:underline uppercase tracking-wider font-bold">Forgot?</button>
              </div>
              <div className="relative group/input">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#0f0f0f] px-4 text-white/30 tracking-widest font-semibold">Or continue with</span></div>
            </div>
